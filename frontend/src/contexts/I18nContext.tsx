...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'create.productPlaceholder': 'Select a product...',
    ...
    'create.purchaseDate': 'Purchase Date',
    'create.purchaseDateHelp': 'Product purchase date',
    'create.requestDate': 'Request Date',
    'create.requestDateHelp': 'Request date - cannot enter a future date',
    'create.serialNumber': 'Serial Number',
    'create.serialNumberPlaceholder': 'Enter serial number (numbers and letters)',
    'create.serialNumberHelp': 'Product serial number (optional - numbers and letters only)',
    ...
    'departments.subtitle': 'Manage departments in your organization',
    'departments.add': 'Add Department',
    'departments.name': 'Department Name',
    'departments.description': 'Description',
    'departments.createdAt': 'Created',
    'departments.create': 'Create Department',
    'departments.edit': 'Edit Department',
    'departments.update': 'Update Department',
    'departments.namePlaceholder': 'Enter department name',
    'departments.descriptionPlaceholder': 'Enter department description (optional)',
    ...
    // Spare Part Requests
    'sparePartRequests.title': 'Spare Part Requests',
    'sparePartRequests.subtitle': 'Manage spare part requests from technicians',
    'sparePartRequests.requestNew': 'Request New Spare Part',
    'sparePartRequests.partName': 'Part Name',
    'sparePartRequests.partNumber': 'Part Number',
    'sparePartRequests.description': 'Description',
    'sparePartRequests.quantity': 'Quantity',
    'sparePartRequests.urgency': 'Urgency',
    'sparePartRequests.status': 'Status',
    'sparePartRequests.technician': 'Technician',
    'sparePartRequests.requestDate': 'Request Date',
    'sparePartRequests.actions': 'Actions',
    'sparePartRequests.enterPartName': 'Enter part name',
    'sparePartRequests.enterPartNumber': 'Enter part number if known',
    'sparePartRequests.describeWhy': 'Describe why you need this spare part and what you did',
    'sparePartRequests.urgency.low': 'Low',
    'sparePartRequests.urgency.normal': 'Normal',
    'sparePartRequests.urgency.urgent': 'Urgent',
    'sparePartRequests.status.pending': 'Pending',
    'sparePartRequests.status.approved': 'Approved',
    'sparePartRequests.status.rejected': 'Rejected',
    'sparePartRequests.status.fulfilled': 'Fulfilled',
    'sparePartRequests.approve': 'Approve',
    'sparePartRequests.reject': 'Reject',
    'sparePartRequests.fulfill': 'Fulfill',
    'sparePartRequests.rejectionReason': 'Rejection Reason',
    'sparePartRequests.enterRejectionReason': 'Enter reason for rejection',
    'sparePartRequests.createSuccess': 'Spare part request created successfully',
    'sparePartRequests.approveSuccess': 'Request approved successfully',
    'sparePartRequests.rejectSuccess': 'Request rejected successfully',
    'sparePartRequests.fulfillSuccess': 'Request fulfilled successfully',
    'sparePartRequests.error': 'An error occurred',
    'sparePartRequests.loading': 'Loading...',
    'sparePartRequests.empty': 'No spare part requests found',
    'sparePartRequests.filters.all': 'All Requests',
    'sparePartRequests.filters.pending': 'Pending',
    'sparePartRequests.filters.approved': 'Approved',
    'sparePartRequests.filters.rejected': 'Rejected',
    'sparePartRequests.filters.fulfilled': 'Fulfilled',
    // Technician Reports
    'technicianReports.title': 'Technician Reports',
    'technicianReports.subtitle': 'View technician work reports',
    'technicianReports.add': 'Add Report',
    'technicianReports.description': 'Report Description',
    'reports.enterDescription': 'Describe what you did and any relevant details',
  ...
  ar: {
    ...
    'create.product': 'المنتج',
    'create.productPlaceholder': 'اختر المنتج...',
    ...
    'create.purchaseDate': 'تاريخ الشراء',
    'create.purchaseDateHelp': 'تاريخ شراء المنتج',
    'create.requestDate': 'تاريخ الطلب',
    'create.requestDateHelp': 'تاريخ الطلب - لا يمكن إدخال تاريخ في المستقبل',
    'create.serialNumber': 'الرقم التسلسلي',
    'create.serialNumberPlaceholder': 'أدخل الرقم التسلسلي (أرقام وحروف)',
    'create.serialNumberHelp': 'الرقم التسلسلي للمنتج (اختياري - أرقام وحروف فقط)',
    ...
    'departments.namePlaceholder': 'أدخل اسم القسم',
    'departments.descriptionPlaceholder': 'أدخل وصف القسم (اختياري)',
    'departments.empty': 'لا توجد أقسام',
    // Storage
    ...
    // Spare Part Requests
    'sparePartRequests.title': 'طلبات قطع الغيار',
    'sparePartRequests.subtitle': 'إدارة طلبات قطع الغيار من الفنيين',
    'sparePartRequests.requestNew': 'طلب قطعة غيار جديدة',
    'sparePartRequests.partName': 'اسم القطعة',
    'sparePartRequests.partNumber': 'رقم القطعة',
    'sparePartRequests.description': 'الوصف',
    'sparePartRequests.quantity': 'الكمية',
    'sparePartRequests.urgency': 'الأولوية',
    'sparePartRequests.status': 'الحالة',
    'sparePartRequests.technician': 'الفني',
    'sparePartRequests.requestDate': 'تاريخ الطلب',
    'sparePartRequests.actions': 'الإجراءات',
    'sparePartRequests.enterPartName': 'أدخل اسم القطعة',
    'sparePartRequests.enterPartNumber': 'أدخل رقم القطعة إذا كان معروفاً',
    'sparePartRequests.describeWhy': 'اوصف لماذا تحتاج هذه القطعة وماذا فعلت',
    'sparePartRequests.urgency.low': 'منخفضة',
    'sparePartRequests.urgency.normal': 'عادية',
    'sparePartRequests.urgency.urgent': 'عاجلة',
    'sparePartRequests.status.pending': 'معلق',
    'sparePartRequests.status.approved': 'موافق عليه',
    'sparePartRequests.status.rejected': 'مرفوض',
    'sparePartRequests.status.fulfilled': 'مكتمل',
    'sparePartRequests.approve': 'موافقة',
    'sparePartRequests.reject': 'رفض',
    'sparePartRequests.fulfill': 'إكمال',
    'sparePartRequests.rejectionReason': 'سبب الرفض',
    'sparePartRequests.enterRejectionReason': 'أدخل سبب الرفض',
    'sparePartRequests.createSuccess': 'تم إنشاء طلب قطعة الغيار بنجاح',
    'sparePartRequests.approveSuccess': 'تم الموافقة على الطلب بنجاح',
    'sparePartRequests.rejectSuccess': 'تم رفض الطلب بنجاح',
    'sparePartRequests.fulfillSuccess': 'تم إكمال الطلب بنجاح',
    'sparePartRequests.error': 'حدث خطأ',
    'sparePartRequests.loading': 'جاري التحميل...',
    'sparePartRequests.empty': 'لا توجد طلبات قطع غيار',
    'sparePartRequests.filters.all': 'جميع الطلبات',
    'sparePartRequests.filters.pending': 'معلق',
    'sparePartRequests.filters.approved': 'موافق عليه',
    'sparePartRequests.filters.rejected': 'مرفوض',
    'sparePartRequests.filters.fulfilled': 'مكتمل',
    // Technician Reports
    'technicianReports.title': 'تقارير الفنيين',
    'technicianReports.subtitle': 'عرض تقارير عمل الفنيين',
    'technicianReports.add': 'إضافة تقرير',
    'technicianReports.description': 'وصف التقرير',
    'reports.enterDescription': 'اوصف ما فعلته وأي تفاصيل ذات صلة',
    ...
    'reports.createSuccess': 'تم إنشاء التقرير بنجاح',
    'reports.updateSuccess': 'تم تحديث التقرير بنجاح',
    'reports.deleteSuccess': 'تم حذف التقرير بنجاح',
    'reports.error': 'حدث خطأ',
    'reports.loading': 'جاري التحميل...',
    'reports.empty': 'لا توجد تقارير',
    'reports.confirmDelete': 'هل أنت متأكد من حذف هذا التقرير؟',
  },
};
